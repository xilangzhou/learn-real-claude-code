...
const TOOL_OVERRIDES: Record<string, string[]> = {
  s01: ["bash"],
  s02: ["bash", "read_file", "write_file", "edit_file"],
  s03: ["bash", "read_file", "write_file", "edit_file", "todo_write"],
  s04: ["bash", "read_file", "write_file", "edit_file", "delegate"],
  s05: ["bash", "read_file", "write_file", "edit_file", "load_skill"],
  s06: ["bash", "read_file", "write_file", "edit_file", "compact"],
  s07: ["bash", "read_file", "write_file", "edit_file", "task_create", "task_get", "task_list", "task_update"],
  s08: ["bash", "read_file", "write_file", "edit_file", "background_run", "background_check"],
  s09: ["bash", "read_file", "write_file", "edit_file", "team_spawn", "send_message", "read_inbox", "team_list"],
  s10: ["bash", "read_file", "write_file", "edit_file", "request_plan", "respond_plan", "request_shutdown", "poll_protocols"],
  s11: ["bash", "read_file", "write_file", "edit_file", "task_create", "task_list", "claim_task", "send_message", "idle"],
  s12: ["bash", "read_file", "write_file", "edit_file", "task_create", "task_list", "ensure_worktree", "log_event"],
};
...
function extractTools(source: string): string[] {
  const toolPattern = /(?:["']name["']\s*:\s*["'](\w+)["']|name\s*=\s*["'](\w+)["'])/g;
...
function main() {
  ...
  for (const filename of agentFiles) {
    ...
    const tools = TOOL_OVERRIDES[versionId] ?? extractTools(source);
