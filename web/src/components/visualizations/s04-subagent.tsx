...
const STEPS = [
  ...
  {
    title: "Spawn Fresh Worker",
    description:
      "Fresh delegation creates a child with its own clean message history. Only the task description is passed in.",
  },
  {
    title: "Isolated Work",
    description:
      "A fresh worker does not inherit the parent's earlier conversation or decisions.",
  },
  {
  ...
  },
  {
    ...
    description:
      "The parent gets a clean summary without context bloat. Forked delegation is a different mode for context-sensitive work.",
  },
];
