...
export function Timeline() {
  ...
  const tCore = useTranslations("session_core_additions");
  const tInsight = useTranslations("session_key_insights");
                ...
                >
                  <div className="flex flex-wrap items-start gap-2">
                    ...
                    <span className="text-xs text-[var(--color-text-secondary)]">
                      {tCore(versionId) || meta.coreAddition}
                    </span>
                  </div>
                  ...
                  <h3 className="mt-2 text-base font-semibold sm:text-lg">
                    ...
                    <span className="ml-2 text-sm font-normal text-[var(--color-text-secondary)]">
                      {tSubtitle(versionId) || meta.subtitle}
                    </span>
                  </h3>
                  ...
                  {meta.keyInsight && (
                    <p className="mt-3 text-sm italic text-[var(--color-text-secondary)]">
                      &ldquo;{tInsight(versionId) || meta.keyInsight}&rdquo;
                    </p>
                  )}
