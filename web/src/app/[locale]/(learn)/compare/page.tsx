      ...
      {infoA && infoB && comparison && (
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle>{tSession(versionA) || metaA?.title || versionA}</CardTitle>
                <p className="text-sm text-zinc-500">{tSubtitle(versionA) || metaA?.subtitle}</p>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle>{tSession(versionB) || metaB?.title || versionB}</CardTitle>
                <p className="text-sm text-zinc-500">{tSubtitle(versionB) || metaB?.subtitle}</p>
              </CardHeader>
              <div className="space-y-2 text-sm text-zinc-600 dark:text-zinc-400">
                <p>{infoB.loc} LOC</p>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
              <div>
                <h3 className="mb-3 text-sm font-medium text-zinc-500 dark:text-zinc-400">
                  {tSession(versionA) || metaA?.title || versionA}
                </h3>
                <ArchDiagram version={versionA} />
              </div>
              <div>
                <h3 className="mb-3 text-sm font-medium text-zinc-500 dark:text-zinc-400">
                  {tSession(versionB) || metaB?.title || versionB}
                </h3>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div>
                <h4 className="mb-2 text-sm font-medium text-zinc-600 dark:text-zinc-400">
                  {t("only_in")} {tSession(versionA) || metaA?.title || versionA}
                </h4>
              ...
              <div>
                <h4 className="mb-2 text-sm font-medium text-zinc-600 dark:text-zinc-400">
                  {t("only_in")} {tSession(versionB) || metaB?.title || versionB}
                </h4>
                {comparison.toolsOnlyB.length === 0 ? (
                  <p className="text-xs text-zinc-400">{t("none")}</p>
                ) : (
