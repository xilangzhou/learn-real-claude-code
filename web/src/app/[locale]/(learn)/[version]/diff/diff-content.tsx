    ...
    <div className="py-4">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold">
          {(prevMeta ? tSession(prevVersion.id) || prevMeta.title : prevVersion.id)} → {tSession(version) || meta.title}
        </h1>
      ...
      <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <Card className="border-l-4 border-l-red-300 dark:border-l-red-700">
          <CardHeader>
                <CardTitle>{tSession(prevVersion.id) || prevMeta?.title || prevVersion.id}</CardTitle>
                <p className="text-sm text-zinc-500">{tSubtitle(prevVersion.id) || prevMeta?.subtitle}</p>
          </CardHeader>
        ...
        <Card className="border-l-4 border-l-green-300 dark:border-l-green-700">
          <CardHeader>
            <CardTitle>{tSession(version) || meta.title}</CardTitle>
            <p className="text-sm text-zinc-500">{tSubtitle(version) || meta.subtitle}</p>
          </CardHeader>
          <div className="space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
